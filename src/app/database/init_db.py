...
TABLES_SQL = """
-- Audit trail: every analysis run
...
-- Study cache: avoid reprocessing identical requests
...
-- HITL reviews: pending human reviews for high-risk analyses
